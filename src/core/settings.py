...
LOGGING = {
    ...
    'handlers': {
        'constructor_file': {
            ...
            'filename': f'{BASE_DIR.joinpath("logs").joinpath("constructor.log")}',
            'formatter': 'default',
        },
        'quizzing_file': {
            'level': 'DEBUG',
            'class': 'logging.FileHandler',
            'filename': f'{BASE_DIR.joinpath("logs").joinpath("quizzing.log")}',
            'formatter': 'default',
        },
    },
    'loggers': {
        'constructor': {
            'handlers': ['constructor_file'],
            'level': 'DEBUG',
            'propagate': True,
        },
        'quizzing': {
            'handlers': ['quizzing_file'],
            'level': 'DEBUG',
            'propagate': True,
        },
    },
...
SERVICE_MAILBOX = local_settings.SERVICE_MAILBOX
SERVICE_MAILBOX_PASSWORD = local_settings.SERVICE_MAILBOX_PASSWORD
ADMINISTRATOR_MAILBOX = local_settings.ADMINISTRATOR_MAILBOX
